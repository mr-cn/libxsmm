...
typedef enum libxsmm_gemm_flags {
  ...
  LIBXSMM_GEMM_FLAG_INTERPRETE_A_AS_INT2_VNNI4_INTLV = 268435456,
  LIBXSMM_GEMM_FLAG_INTERPRETE_A_AS_INT1_VNNI4 = 536870912,
  /* combined types */
  ...
  /** Marker flag; do not use. */
  LIBXSMM_GEMM_FLAG_INVALID = 1073741824
} libxsmm_gemm_flags;

...
void libxsmm_generator_gemm_apply_ops_input_tensor_and_store_to_stack_rv64( libxsmm_generated_code*    io_generated_code,
  ...
  if (is_offset_brgemm > 0) {
    ...
    libxsmm_rv64_instruction_alu_compute( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADD, i_tmp_reg, i_loop_reg, i_tmp_reg );
    libxsmm_rv64_instruction_alu_move( io_generated_code, LIBXSMM_RV64_INSTR_GP_LD, i_tmp_reg, i_tmp_reg, 0);
    libxsmm_rv64_instruction_alu_compute( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADD, i_tmp_reg, i_gp_reg_in, i_gp_reg_in );
  }
  ...
  if (i_op2_type != LIBXSMM_MELTW_TYPE_UNARY_NONE) {
    ...
    if (is_brgemm > 0) {
      libxsmm_rv64_instruction_alu_compute( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADD, i_tmp_reg3, i_tmp_reg, i_tmp_reg );
  ...
  if (libxsmm_meqn_is_unary_opcode_transform_kernel(LIBXSMM_CAST_USHORT(i_op_type)) > 0) {
    ...
    libxsmm_generator_meltw_destroy_stack_frame_rv64(  io_generated_code, l_mateltwise_desc, &l_mateltwise_kernel_config );
  }
...
void libxsmm_generator_gemm_getval_stack_var_rv64( libxsmm_generated_code* io_generated_code,
  ...
  libxsmm_rv64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADDI, LIBXSMM_RV64_GP_REG_X9, i_gp_reg, offset );
  libxsmm_rv64_instruction_alu_move( io_generated_code, LIBXSMM_RV64_INSTR_GP_LD, i_gp_reg, i_gp_reg, 0 );
}
...
void libxsmm_generator_gemm_setval_stack_var_rv64( libxsmm_generated_code*  io_generated_code,
  ...
  libxsmm_rv64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADDI, LIBXSMM_RV64_GP_REG_X9, i_aux_reg, offset );
  libxsmm_rv64_instruction_alu_move( io_generated_code, LIBXSMM_RV64_INSTR_GP_SD, i_aux_reg, i_gp_reg, 0 );
}
...
void libxsmm_generator_gemm_setup_stack_frame_fill_ext_gemm_stack_vars_rv64(
  ...
  if ((is_brgemm == 1) && ((libxsmm_cpuid_arm_mmla_gemm_pack_b_to_vnnit_on_stack() > 0) || (i_micro_kernel_config->decompress_A == 1) || ((LIBXSMM_GEMM_FLAG_TRANS_A & i_xgemm_desc->flags) > 0))) {
    libxsmm_rv64_instruction_alu_move( io_generated_code, LIBXSMM_RV64_INSTR_GP_LD, i_gp_reg_mapping->gp_reg_reduce_count, val_reg, 0 );
...
void libxsmm_generator_gemm_setup_stack_frame_allocate_scratch_rv64(
  ...
  if ( (LIBXSMM_GEMM_FLAG_TRANS_A & i_xgemm_desc->flags) > 0 ) {
    ...
    if (is_brgemm == 0) {
      ...
      libxsmm_rv64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_RV64_INSTR_GP_SUB, temp_reg, temp_reg2, temp_reg, a_size );
      ...
      libxsmm_rv64_instruction_alu_compute( io_generated_code, LIBXSMM_RV64_INSTR_GP_SUB, temp_reg2, temp_reg, temp_reg2 );
    ...
    libxsmm_rv64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADDI, LIBXSMM_RV64_GP_REG_XSP, temp_reg, 0 );
    libxsmm_rv64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADDI, temp_reg, temp_reg, -128 );
    libxsmm_rv64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADDI, temp_reg, LIBXSMM_RV64_GP_REG_XSP, 0 );
...
void libxsmm_generator_gemm_setup_stack_frame_rv64(
  ...
  LIBXSMM_UNUSED(temp_reg2);

  libxsmm_rv64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADDI, LIBXSMM_RV64_GP_REG_XSP, LIBXSMM_RV64_GP_REG_X9, 0 );
...
void libxsmm_generator_gemm_destroy_stack_frame_rv64( libxsmm_generated_code* io_generated_code) {
  libxsmm_rv64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_RV64_INSTR_GP_ADDI, LIBXSMM_RV64_GP_REG_X9, LIBXSMM_RV64_GP_REG_XSP, 0 );
}
...
void libxsmm_generator_gemm_setup_A_vnni_or_trans_B_vnni_or_trans_tensor_to_stack_rv64( libxsmm_generated_code*        io_generated_code,
  ...
  libxsmm_rv64_instruction_restore_regs( io_generated_code, 0x3fff );
}
